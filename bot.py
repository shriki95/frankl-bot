...
{
  "event": "אירוע שהוזכר במפורש במילים של האדם, null אם אין",
...
דוגמה נכונה: "פוטרתי ממספר עבודות" → event: "פוטר ממספר עבודות בעבר"
דוגמה שגויה: "פוטרתי" → event: "חווה כישלון מקצועי וטראומה" - זו פרשנות, אסור."""
